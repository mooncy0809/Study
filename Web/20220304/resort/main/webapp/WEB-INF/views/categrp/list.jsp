  ...
  <TABLE class='table table-striped'>
    ...
    <c:forEach var="categrpVO" items="${list}">
      ...
      <TR>
        ...
        <TD class="td_bs_left"><a href="../cate/list_by_categrpno.do?categrpno=${categrpno }">${categrpVO.name }</a></TD>
        ...
        <TD class="td_bs">
          <A href="../cate/create.do?categrpno=${categrpno }" title="${name }등록"><span class="glyphicon glyphicon-plus-sign"></span></A> 
