...
<DIV class='content_body'>
  ...
  <TABLE class='table table-striped'>
    ...
    <tbody>
    <c:forEach var="bcategrpVO" items="${list}">
      <c:set var="bcategrpno" value="${bcategrpVO.bcategrpno }" />
      <TR>
        <TD class="td_bs">${bcategrpVO.seqno }</TD>
        <TD class="td_bs_left">${bcategrpVO.name }</TD>
        <TD class="td_bs">${bcategrpVO.rdate.substring(0, 10) }</TD>
        <TD class="td_bs">${bcategrpVO.visible }</TD>
        <TD class="td_bs">
